    ...
    <html lang="en">
      <body className={inter.className}>
        <div className=" relative min-h-screen isolate overflow-hidden border-b border-gray-200 bg-white">
          ...
          <div className=" mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex gap-16 lg:px-8 lg:py-24">
            <div className=" h-full w-full flex flex-col items-center gap-4">
              ...
              <p className=" max-w-xl text-center text-lg text-slate-700">
                A wonderfully created search engine that increaces search
                accuracy by querying senantically related results
              </p>
